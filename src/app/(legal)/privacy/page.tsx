        ...
        <div className="min-h-screen bg-gray-100 py-10">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <p className="mb-4 text-lg text-gray-700">
                    We collect information you provide directly to us, such as when you create an account, fill out a form, or contact us. We also collect information automatically, such as your IP address and browsing behavior.
                </p>
                <h2 className="mb-4 text-2xl font-semibold">How We Use Your Information</h2>
                <p className="mb-4 text-lg text-gray-700">
                    We use your information to provide and improve our services, communicate with you, and comply with legal obligations. We do not sell your personal information to third parties.
                </p>
                <h2 className="mb-4 text-2xl font-semibold">Your Rights</h2>
                <p className="mb-4 text-lg text-gray-700">
                    You have the right to access, update, or delete your personal information. You can also object to the processing of your data or request data portability.
                </p>
