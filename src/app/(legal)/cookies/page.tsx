    ...
    return (
        <div className="min-h-screen bg-gray-100 py-10">
            <div className="mx-auto max-w-4xl px-4">
                ...
                <p className="mb-4 text-lg text-gray-700">
                    Cookies are small text files stored on your device by your web browser. They help us understand how you use our site and improve your experience.
                </p>
                <h2 className="mb-4 text-2xl font-semibold">How We Use Cookies</h2>
                <p className="mb-4 text-lg text-gray-700">
                    We use cookies to remember your preferences, analyze site traffic, and provide personalized content. We may also use third-party cookies for advertising and analytics.
                </p>
                ...
                <p className="mb-4 text-lg text-gray-700">
                    We may update this Cookies Policy from time to time. We encourage you to review this page periodically for any changes.
                </p>
            </div>
        </div>
    );
