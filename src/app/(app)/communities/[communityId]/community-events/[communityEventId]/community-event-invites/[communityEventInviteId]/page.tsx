...
export default async function CommunityEventInvitePage({
  ...
  params: { communityEventInviteId: string };
}) {
  ...
  return (
    <Suspense fallback={<Loading />}>
      <div className="relative">
        ...
        <OptimisticCommunityEventInvite communityEventInvite={communityEventInvite} communityEvents={communityEvents}
        communityEventId={communityEventInvite.communityEventId} />
      </div>
    </Suspense>
  );
};
