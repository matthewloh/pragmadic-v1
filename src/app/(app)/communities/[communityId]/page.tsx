...
const Community = async ({ id }: { id: string }) => {
  ...
  const { community, communityPosts, communityEvents } = await getCommunityByIdWithCommunityPostsAndCommunityEvents(id);
  ...
  return (
    <Suspense fallback={<Loading />}>
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{community.name}&apos;s Community Posts</h3>
        <CommunityPostList
          communities={[]}
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{community.name}&apos;s Community Events</h3>
        <CommunityEventList
          communities={[]}
          communityId={community.id}
