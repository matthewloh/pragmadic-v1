...
const NomadProfileForm = ({
    ...
    const handleSubmit = async (data: FormData) => {
        ...
        const nomadProfileParsed =
            await insertNomadProfileParams.safeParseAsync({ ...payload })
        ...
        try {
            startMutation(async () => {
                ...
                const error = editing
                    ? await updateNomadProfileAction({
                          ...values,
                          id: nomadProfile.id,
                      })
        ...
        >
            ...
            <div>
                ...
                <Input
                    ...
                    name="skills"
                    className={cn(
                        errors?.skills ? "ring ring-destructive" : "",
                    )}
            ...
            <div>
                ...
                <Input
                    ...
                    name="interests"
                    className={cn(
                        errors?.interests ? "ring ring-destructive" : "",
                    )}
            ...
            <div>
                ...
                <Input
                    ...
                    className={cn(
                        errors?.currentLocation ? "ring ring-destructive" : "",
                    )}
                    defaultValue={nomadProfile?.currentLocation ?? ""}
                />
                {errors?.currentLocation ? (
                    <p className="mt-2 text-xs text-destructive">
                        {errors.currentLocation[0]}
                    </p>
                ) : (
                    <div className="h-6" />
                )}
                ...
                <Button
                    ...
                    onClick={() => {
                        ...
                        startMutation(async () => {
                            ...
                            const error = await deleteNomadProfileAction(
                                nomadProfile.id,
                            )
                            setIsDeleting(false)
                            const errorFormatted = {
