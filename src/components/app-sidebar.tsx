...
export function AppSidebar() {
    ...
    if (!role) return null
    const getProfileItems = (role: string) => {
        const baseItems = [
            {
                title: "System Profile",
                url: "/profile",
                icon: User,
                description: "Manage your system profile",
            },
        ]
        switch (role) {
            case "regular":
                ...
                items: [
                    {
                        ...
                        icon: MessageSquare,
                        description:
                            "Chat with an intelligent context-aware agent",
                    },
                    {
                ...
                items: [
                    {
                        ...
                        icon: MapPin,
                        description:
                            "Explore the states available in DE Rantau",
                    },
                ],
            },
        ],
