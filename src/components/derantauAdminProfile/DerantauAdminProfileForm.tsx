...
const DerantauAdminProfileForm = ({
    ...
    const handleSubmit = async (data: FormData) => {
        ...
        const derantauAdminProfileParsed =
            await insertDerantauAdminProfileParams.safeParseAsync({
                regionId,
                ...payload,
            })
        ...
        try {
            startMutation(async () => {
                ...
                const error = editing
                    ? await updateDerantauAdminProfileAction({
                          ...values,
                          id: derantauAdminProfile.id,
                      })
        ...
        >
            ...
            <div>
                ...
                <Input
                    ...
                    name="department"
                    className={cn(
                        errors?.department ? "ring ring-destructive" : "",
                    )}
            ...
            <div>
                ...
                <Input
                    ...
                    name="position"
                    className={cn(
                        errors?.position ? "ring ring-destructive" : "",
                    )}
            ...
            <div>
                ...
                <Input
                    ...
                    name="adminLevel"
                    className={cn(
                        errors?.adminLevel ? "ring ring-destructive" : "",
                    )}
            ...
            {regionId ? null : (
                <div>
                    ...
                    <Select
                        defaultValue={derantauAdminProfile?.regionId}
                        name="regionId"
                    >
                        <SelectTrigger
                            className={cn(
                    ...
                    onClick={() => {
                        ...
                        startMutation(async () => {
                            addOptimistic &&
                                addOptimistic({
                                    action: "delete",
                                    data: derantauAdminProfile,
                                })
                            const error =
                                await deleteDerantauAdminProfileAction(
                                    derantauAdminProfile.id,
                                )
                            setIsDeleting(false)
                            const errorFormatted = {
                                error: error ?? "Error",
