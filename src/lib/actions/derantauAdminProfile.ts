...
const revalidateDerantauAdminProfiles = () =>
    revalidatePath("/derantau-admin-profile")

export const createDerantauAdminProfileAction = async (
    input: NewDerantauAdminProfileParams,
) => {
    try {
...
export const updateDerantauAdminProfileAction = async (
    input: UpdateDerantauAdminProfileParams,
) => {
    try {
...
export const deleteDerantauAdminProfileAction = async (
    input: DerantauAdminProfileId,
) => {
    try {
